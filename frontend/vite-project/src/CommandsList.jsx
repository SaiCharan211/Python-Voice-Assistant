...
// const commands = [
//     { title: "Time", description: "Say 'time' to get the current time." },
//     { title: "Joke", description: "Say 'joke' to get a random programming joke." },
//     { title: "Weather", description: "Say 'weather in [city]' to get current weather." },
//     { title: "Forecast", description: "Say 'forecast in [city]' to get 7-day weather forecast." },
//     { title: "Air Quality", description: "Say 'air quality in [city]' to get AQI info." },
//     { title: "Open Websites", description: "Say 'open YouTube' or 'open Google'." },
//     { title: "System Apps", description: "Say 'open Notepad', 'open Calculator', 'open Downloads'." },
//     { title: "Voice Commands", description: "Click the 🎤 button and speak commands directly." }
// ];
